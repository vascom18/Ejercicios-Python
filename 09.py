...
en pantalla la primera letra del texto ingresado. Luego, solicitar al usuario que ingrese un número positivo menor a la cantidad de
 caracteres que tiene el texto que ingresó (por ejemplo, si escribió la palabra “HOLA”, tendrá que ser un número entre 0 y 4) y 
...
selector = int(
    input('ingrese un numero entero menor o igual a' + str(len(text)) + ':'))

print('el caracter en esa posicion es: ' + text[selector-1])
